...
export const Home = () => {
  return (
    <div class="flex flex-col items-center justify-center w-full h-full">
      <h1 class="text-4xl text-gray-600 font-bold text mb-2 max-w-2xl text-center">OMA - OPA Management Application</h1>
...
export const ActionButton = (props: { text: string; icon: string; href: string }) => {
  return (
    <A
      href={props.href}
      class="flex items-center w-full bg-gray-200 hover:bg-gray-300 text-gray-600 py-2 px-4 rounded"
    >
      <img src={props.icon} class="w-8 h-8 mr-4" />
      {props.text}
    </A>
  )
}
